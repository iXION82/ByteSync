    ...
    <div className="auth-card">
      ...
      <div className="auth-card-inner">
        <div className="auth-header">
          ...
          <h1 className="auth-title">{">"} SIGN_IN_</h1>
          <p className="auth-subtitle">Access your terminal session</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          <div className="auth-field">
            <label htmlFor="signin-email" className="auth-label">EMAIL_ADDRESS</label>
